...
import './../../styles/input_fields_styles/TextInputStyle.css';
...
const TextInput = ({
    ...
    return (
        <div className={`container ${small ? "small" : ""}`}>
            <label className={`label ${error ? "error" : ""} ${small ? "small" : ""} ${popup ? "popup" : ""}` }>
                {label}
            </label>
            <div
                className={`outlined-input ${error ? "error" : ""} ${chipableInput ? "chipable" : ""} ${small ? "small" : ""} ${popup ? "popup" : ""}`}
                style={{ minHeight: height }}
            >
                {chipableInput ? (
                    <div className="chip-wrapper">
                        {chipableArray.map((chip, index) => (
                            <div className="chip" key={index} onClick={() => removeChip(name, index)}>
                                <span>{chip}</span>
                    ...
                    <>
                        <textarea
                            className={`input ${small ? "small" : ""} ${popup ? "popup" : ""}`}
            ...
            {error && <p className={`error-message ${small ? "small" : ""} ${popup ? "popup" : ""}`}>{error}</p>}
        </div>
    );
};
