...
import { uploadAdminProfilePicture, deleteAdmin } from './../../apis/Api.js';
import { useDispatch } from "react-redux";
import { useNavigate } from "react-router-dom";
import { updateProfilePictureSuccess, logout, deleteUserSuccess } from './../../redux/reducers/userSlice.js';


const AdminProfile = ({ currentUser, show, handleClose }) => {
    ...
    const handleImageUpload = async (e) => {
        ...
        try {
            const response = await uploadAdminProfilePicture(formData);
    ...
    const handleDeleteAccount = async () => {
        try {
            const response = await deleteAdmin({ email: currentUser.email });
