...
import TrainerProfileSection from './TrainerProfileSection.jsx';

const TrainerProfile = ({ currentUser }) => {
    return (
        <>
            <LayoutDashboard>
                <TrainerProfileSection currentUser={currentUser}/>
            </LayoutDashboard>
        </>
    );
};
...
// import { uploadTrainerProfilePicture, deleteTrainer } from './../../apis/Api.js';
// import { useDispatch } from "react-redux";
// import { useNavigate } from "react-router-dom";
// import { updateProfilePictureSuccess, logout, deleteUserSuccess } from './../../redux/reducers/userSlice.js';

// const TrainerProfile = ({ currentUser, show, handleClose }) => {
...
//         try {
//             const response = await uploadTrainerProfilePicture(formData);
...
//         try {
//             const response = await deleteTrainer({ email: currentUser.email });
