    ...
    return (
        ...
        <section className="home-section2">
            <Container className="home-section2-container">
                ...
                {/* Features Carousel */}
                <Carousel activeIndex={index} onSelect={handleSelect} className="feature-carousel" indicators={false}>
                    <Carousel.Item>
                        <Row className="feature-row">
                            <Col xs={12} sm={6} md={6} lg={3} className="feature-card">
                                ...
                                <h4>Flex Muscle</h4>
                                <p>Improve strength and endurance with professional guidance.</p>
                            ...
                            <Col xs={12} sm={6} md={6} lg={3} className="feature-card">
                                ...
                                <p>Get personalized nutrition plans to boost your performance.</p>
                                <Link to="#">Read more</Link>
                            </Col>
                            ...
                            <Col xs={12} sm={6} md={6} lg={3} className="feature-card">
                                ...
                                <p>Strengthen your core with expert abdominal workouts.</p>
                                <Link to="#">Read more</Link>
                            </Col>
                            ...
                            <Col xs={12} sm={6} md={6} lg={3} className="feature-card">
                                ...
                                <p>Improve muscle growth with guided weight-lifting techniques.</p>
                                <Link to="#">Read more</Link>
                            </Col>
                        </Row>
                    </Carousel.Item>
